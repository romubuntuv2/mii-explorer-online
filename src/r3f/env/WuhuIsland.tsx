...
const WuhuIsland = ({position, scale}:{position:[number,number,number], scale:number}) => {


  const { nodes, materials } = useGLTF('/models/Wuhu_Island.glb')
...
export default WuhuIsland

useGLTF.preload('/models/Wuhu_Island.glb')